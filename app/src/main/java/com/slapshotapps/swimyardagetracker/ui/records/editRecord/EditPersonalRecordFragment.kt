...
class EditPersonalRecord : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_edit_personal_record, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment EditPersonalRecord.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                EditPersonalRecord().apply {
