...
val MIGRATION_1_2 = object : Migration(1, 2) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("CREATE TABLE IF NOT EXISTS `personal-records` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `stroke` TEXT NOT NULL, `distance` INTEGER NOT NULL)")
